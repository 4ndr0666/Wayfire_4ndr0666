...
apply_st() {
    ...
    *.color15:      ${color15}
    ...
    # Merge the Xresources changes into X server
    xrdb -merge ~/.Xresources

    # Optionally send a notification
    notify-send -h string:x-canonical-private-synchronous:sys-notify-sttheme -u normal -i ${PATH_MAKO}/icons/palette.png "Applied colorscheme to ST terminal."
}
